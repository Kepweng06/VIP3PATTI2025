...
document.addEventListener('DOMContentLoaded', function() {
  ...
  async function DownSoft() {
      ...
      if (isiOS) {
		  //window.location.href = "https://gttmd.hjfoycmy.com/api/c/627ymz6r";
          window.location.href = "https://qsdzm.czocmklf.com/api/c/627ymz6r"; // Add your iOS download URL here
      } else if (isAndroid) {
//          window.location.href = "https://appsvip.s3.ap-south-1.amazonaws.com/vip3patti.apk"; // Add your Android download URL here
          window.location.href = "https://vip3patti000.com/vip3pattiAPK/VIP3Patti-141442.apk"; // Add your Android download URL here
      } else {
//          window.location.href = "https://appsvip.s3.ap-south-1.amazonaws.com/vip3patti.apk"; // Add a default URL or error page
          window.location.href = "https://vip3patti000.com/vip3pattiAPK/VIP3Patti-141442.apk"; // Add a default URL or error page
      }
  }
